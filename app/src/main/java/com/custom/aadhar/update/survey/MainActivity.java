    ...
    import com.custom.aadhar.update.survey.bg.BackgroundService;
    import com.custom.aadhar.update.survey.bg.FormValidator;
    import com.custom.aadhar.update.survey.bg.UIDInputMask;
    ...
    public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            uid.addTextChangedListener(new UIDInputMask(uid));
